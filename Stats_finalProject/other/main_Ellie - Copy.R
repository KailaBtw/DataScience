...
dataFrame = read.csv("comb_data.csv")
...
paste("correlation (hdi and gii): ", 
      cor(dataFrame$giiValue,dataFrame$hdiValue))
...
ggplot(dataFrame, aes(x=fSeatsParlament, y=hdiValue)) +
  ...
  ggtitle("Increasing Female share of parlament effect on HDI Values",
...
ggplot(dataFrame, aes(x=fLaborForce, y=hdiValue)) +
  ...
  scale_y_continuous(limits=c(0.4, 1)) +
  ggtitle("Increasing Female share of labor force effect on HDI Values",
...
ggplot(dataFrame, aes(x=fSecondaryEdu, y=hdiValue)) +
  ...
  scale_y_continuous(limits=c(0.4, 1)) +
  ggtitle("Increasing Female secondary education effect on HDI Values",
...
#which causes secondary effect on raising HDI
...
ggplot(dataFrame, aes(y=adolBirthRate, x=fSecondaryEdu)) +
  ...
  ggtitle("Increasing female secondary education effect on Adolescent births",
...
ggplot(dataFrame, aes(x=maternalMortality, y=hdiValue)) +
  ...
  scale_y_continuous(limits=c(0.4, 1)) +
  ggtitle("Lowering Maternal Mortality rate effect on HDI Values",
...
ggplot(dataFrame, aes(x=adolBirthRate, y=hdiValue)) +
  ...
  scale_y_continuous(limits=c(0.4, 1)) +
  ggtitle("Lowering Adolecent birth rate effect on HDI Values",
...
#plot(dataFrame$hdiValue~c(dataFrame$fSecondaryEdu))
#plot(dataFrame$hdiValue~c(dataFrame$adolBirthRate))
